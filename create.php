...
if (isset($_POST['submit'])) {
    ...
    //! Inserción
    $sql = "INSERT INTO Students (fname,lname,email,phone) VALUES('$fname','$lname','$email','$phone')";
                ...
                <form action="<?php echo htmlspecialchars(
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="fname">Nombre del alumno</label>
                      ...
                      <input type="text" class="form-control shadow" name="fname" placeholder="Nombre del alumno"/>
                    </div>
                  </div>
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    ...
                    <label class="form-label" for="lname">Apellido del alumno</label>
                      ...
                      <input type="text" class="form-control shadow" name="lname" placeholder="Apellido del alumno" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="email">Email</label>
                      ...
                      <input type="email" name="email" class="form-control shadow" placeholder="example@gmail.com" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="phone">Teléfono</label>
                      <input type="tel" class="form-control shadow" name="phone" placeholder="ejem: 9999999999" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" name="submit" value="submit" class="btn btn-primary btn-lg">Guardar</button><br>
